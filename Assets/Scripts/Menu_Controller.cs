...
public class Menu_Controller : MonoBehaviour {
    ...
    [Tooltip("_sceneToLoadOnNewGame is the name of the scene that will be loaded when users click play")]
    public string _sceneToLoadOnNewGame = "Intro";
    [Tooltip("_sceneToLoadOnResume is the name of the scene that will be loaded when users click play")]
    public string _sceneToLoadOnResume = "Map";
	...
	public void NewGame () {
		...
		UnityEngine.SceneManagement.SceneManager.LoadScene(_sceneToLoadOnNewGame);
	}
    ...
    public void Resume()
    {
        _audioSource.PlayOneShot(_audioClip);
        PlayerPrefs.SetString("_LastScene", scene.name);
        UnityEngine.SceneManagement.SceneManager.LoadScene(_sceneToLoadOnResume);
    }
